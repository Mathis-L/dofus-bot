...
class BotInterface:
    ...
    def setup_gui(self) -> None:
        ...
        tk.Label(restriction_frame1, text="Coin supérieur gauche - X:").pack(side=tk.LEFT)
        ...
        tk.Label(restriction_frame2, text="Coin inférieur droit - X:").pack(side=tk.LEFT)
        ...
        tk.Label(pod_frame, text="Pod utilisé:").pack(side=tk.LEFT)
